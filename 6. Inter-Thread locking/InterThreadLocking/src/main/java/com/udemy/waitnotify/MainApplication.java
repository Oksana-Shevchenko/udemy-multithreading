...
public class MainApplication {
    ...
    private static final String INPUT_FILE = "./src/main/resources/matrices";
    private static final String OUTPUT_FILE = "./src/main/resources/matrices_result";
    ...
    private static class MatricesMultiplierConsumer extends Thread {
        ...
        public void run() {
            while (true) {
                ...
                float[][] result = multipleMatrices(matricesPair.matrix1, matricesPair.matrix2);
                try {
                    safeMatrixToFile(fileWriter, result);
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
        ...
        private void safeMatrixToFile(FileWriter fileWriter, float[][] matrix) throws IOException {
            for (int r = 0; r < N; r++) {
        ...
        private float[][] multipleMatrices(float[][] m1, float[][] m2) {
        ...
        public void run() {
            while (true) {
                ...
                if (matrix1 == null || matrix2 == null) {
                    queue.terminate();
                    System.out.println("No more matrices to read. Producer Thread is terminated");
                    return;
                }
